...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
	pageEncoding="UTF-8"%>
<%
	int pro_no = Integer.parseInt(request.getParameter("work_no"));
	String pro_file_name = null;
	
	if(pro_no != 0) {
		if (request.getParameter("work_file_name") != null) {
			pro_file_name = request.getParameter("work_file_name");
			String savePath = request.getParameter("work_file_addr");
			File file = null;
